...
<script type="text/javascript" src="resources/bootstrap/js/bootstrap.min.js"></script>
 ...
 <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark">
    	<a class="navbar-brand" href="adminpanel.php">AdminArea</a>
        ...
        id="navbars">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item"> <a class="nav-link" href="adminpanel.php">Dashboard <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item"> <a class="nav-link" href="user.php">Users</a>
                </li> 
                <li class="nav-item"> <a class="nav-link" href="team.php">Bus</a>
                </li> 
                <li class="nav-item"> <a class="nav-link" href="owner.php">Bus Seat Overview</a>
                </li>  
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"> <a class="nav-link" href="admin_logout.php">Logout</a>
                </li>
            </ul>
            </div>
              </nav>
