        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                if(isset($_POST['submit'])) {
                    $source = $_POST['post_source'];
                    $destination = $_POST['post_destination'];
                  ...
                  if ($source=="" || $destination=="") {
                    ...
                    $query = "SELECT * FROM `posts` WHERE `post_source` = '$source ' AND `post_destination` LIKE '$destination'";
                    ...
                    if($count == 0) {
                        echo "<h4>NO BUS AVAILABLE FOR THIS ROUTE !! SEARCH DIFFERENT ROUTE</h4>";
                    }
